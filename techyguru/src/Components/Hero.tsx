    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 opacity-0 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 mb-8 md:mb-10 max-w-3xl mx-auto px-4 opacity-0 animate-slide-up" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 opacity-0 animate-slide-up" style={{ animationDelay: '0.8s' }}>
